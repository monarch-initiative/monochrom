 ...
 * [chr.yml](chr.yml)
     * Determines how your purl.obolibrary.org/obo/chr/ redirects will be handled
     ...
     * Paste in the contents of [chr.yml](chr.yml)
 ...
 * [chr.md](chr.md)
     ...
     * Paste in the contents of [chr.md](chr.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
