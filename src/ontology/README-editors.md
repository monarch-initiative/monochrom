These notes are for the EDITORS of chr
...
Make sure you have an ID range in the [idranges file](chr-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [chr-edit.owl](chr-edit.owl)

** DO NOT EDIT chr.obo OR chr.owl in the top level directory **

[../../chr.owl](../../chr.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch-initiative/monochrom) for details.
 ...
 * [chr-idranges.owl](chr-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/chr_terms.txt file
...
Note: the chr_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as chr.owl and chr.obo and places
 ...
 * https://github.com/monarch-initiative/monochrom/releases
 * https://github.com/monarch-initiative/monochrom/releases/new
...
what is in the `owl:versionIRI` of the derived chr.owl (`data-version` in
chr.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/chr.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/chr/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch-initiative/monochrom.svg?branch=master)](https://travis-ci.org/monarch-initiative/monochrom)
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to monochrom
